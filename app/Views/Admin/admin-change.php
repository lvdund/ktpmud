...
<article class="page-container">
	<form action="<?= base_url() ?>/admin/admin/update/<?= $admin['idAdmin'] ?>" method="Post" class="form form-horizontal">

		<div class="row cl" hidden>
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>id</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= $admin['idAdmin'] ?>" placeholder="" id="username" name="idAdmin" >
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Email：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= $admin['tkAdmin'] ?>" placeholder="" id="username" name="tkAdmin" disabled>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Name：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= $admin['tenAdmin'] ?>" placeholder="" id="name" name="tenAdmin">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Password：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="password" name="mkAdmin">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Mobile：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= $admin['sdtAdmin'] ?>" placeholder="" id="mobile" name="sdtAdmin">
			</div>
		</div>
