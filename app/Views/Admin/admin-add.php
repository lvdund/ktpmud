...
<article class="page-container">
	<form action="<?= base_url() ?>/admin/admin/create" method="post" class="form form-horizontal" id="form-doctor-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Email：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= old('tkAdmin') ?>" placeholder="Email" id="username" name="tkAdmin">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Name：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= old('tenAdmin') ?>" placeholder="Name" id="name" name="tenAdmin">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Password：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="password" id="password" name="mkAdmin">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?= old('sdtAdmin') ?>" placeholder="" id="mobile" name="sdtAdmin">
			</div>
		</div>
