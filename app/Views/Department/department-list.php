...
<title>Deparment Managerment</title>
</head>
<body>
<nav class="breadcrumb"><a href="<?= base_url() ?>/admin/home"><i class="Hui-iconfont">&#xe67f;</i></a> Front page<span class="c-gray en">&gt;</span></span>Department Management <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="100">Id of Dean</th>
				<th width="200">Dean</th>
			</tr>
		</thead>
		
		<tbody>
			<?php foreach ($tkhoa as $item) : ?>
				<tr class="text-c">
					<td><?= $item['tenKhoa'] ?></td>
					<td><?= $item['emailKhoa'] ?></td>
					<td><?= $item['sdtKhoa'] ?></td>
					<td><?= $item['idTruongKhoa'] ?></td>
