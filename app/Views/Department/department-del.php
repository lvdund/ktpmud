...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> front page <span class="c-gray en">&gt;</span>Department center <span class="c-gray en">&gt;</span>Deleted department<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> Date range：
		...
		<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> search department</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> Delete department</a> </span> <span class="r">Shared data：<strong> 69 </strong> strip</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="40">ID of dean</th>
				<th width="120">Dean</th>
