...
<body>
<nav class="breadcrumb"><a href="<?= base_url() ?>/user"><i class="Hui-iconfont">&#xe67f;</i></a> Front page<span class="c-gray en">&gt;</span>Product Management <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>

<div class="page-container">
	<div class="mt-20">
	<?= view('message/message') ?>
	<!-- <input type="date" class="input-text" value="" placeholder="Date of birth" id="Date of birth" name="Date of birth"> -->
		...
		<tbody>
			<?php foreach ($dichvu as $item) : ?>
				<tr class="text-c">
					...
					<td>
						<a href="<?= base_url();?>/user/add/<?= $item['maDichVu'] ?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i></a>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
