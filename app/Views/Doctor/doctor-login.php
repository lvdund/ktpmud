...
<html>
    ...
    <body>
        ...
        <div class="form-container sign-in-container">
            <form action="<?= base_url() ?>/doctor/login" method="get">
                <h1>Sign in</h1>
                ...
                <input name='tkBacSi' value="<?= old('tkBacSi') ?>" type="email" placeholder="Email" />
                <input name='mkBacSi' value="<?= old('mkBacSi') ?>" type="password" placeholder="Password" />
