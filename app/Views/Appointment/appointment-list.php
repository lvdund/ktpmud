...
<body>
<nav class="breadcrumb"><a href="<?=base_url()?>/admin"><i class="Hui-iconfont">&#xe67f;</a></i> Front page<span class="c-gray en">&gt;</span>Appointment management <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
