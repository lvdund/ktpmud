...
<body>
<nav class="breadcrumb"><a href="<?= base_url() ?>/admin/home"><i class="Hui-iconfont">&#xe67f;</i></a> Front page<span class="c-gray en">&gt;</span>Product Management <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
	<form>
		<div class="text-c">
			...
			<input type="text" class="input-text" style="width:300px" placeholder="Điền tên dịch vụ" id="" name="tendichvu">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="<?= base_url();?>/admin/product/add" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> Add user</a></span> <span class="r">Shared data：<strong>88</strong> </span> </div>
	<!--  -->
	<div class="mt-20">
		...
		<tbody>
			<?php foreach ($dichvu as $item) : ?>
				<tr class="text-c">
					...
					<td>
						<a href="<?= base_url();?>/admin/product/delete/<?= $item['maDichVu'] ?>" class="btn btn-danger radius btn-del-comfirmm"><i class="Hui-iconfont">&#xe6e2;</i></a>
						<a href="<?= base_url();?>/admin/product/edit/<?= $item['maDichVu'] ?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i></a>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
